...
function pal_swap_set(palette_sprite_index, palette_index,paletteisSurface)
	{
		...
		{   //Using a sprite based palette
		    ...
		    var tex = sprite_get_texture(palette_sprite_index, 0);
		    var UVs = sprite_get_uvs(palette_sprite_index, 0);
		    ...
		    var texel_hx = texel_x / 2;
		    var texel_hy = texel_y / 2;
		    ...
		    shader_set_uniform_f(Pal_Index, palette_index);
		}
		//else
